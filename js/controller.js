...
mapsApp.controller('mapsController', function($scope, $compile, $timeout,
        $mdSidenav, $log, directionsFactory) {
        ...
        $scope.onChangeHandler = function(_latLonValue) {
          directionsFactory.setLatLon(_latLonValue);
          directionsFactory.setDirectionsService(directionsService);
          directionsFactory.setDirectionsDisplay(directionsDisplay);
          $scope.toggleModal();
        ...
        $scope.showInfoClick = function(cityYearRank) {
            ...
            // if ($scope.selectedPlace !== undefined && $scope.selectedPlace.id !== undefined) {
            //     _aPlaceTypes.push($scope.places[$scope.selectedPlace.id].original);
            // }
        ...
        $scope.showDirections = function () {
           ...
           var dirServ = directionsFactory.getDirectionsService();
           var dirDisp = directionsFactory.getDirectionsDisplay();
           var latLon = directionsFactory.getLatLon();
           calculateAndDisplayRoute(dirServ, dirDisp,
                latLon);
           $scope.toggleModal();
           //clear input fields
           $('#city').val('');
        ...
        function calculateAndDisplayRoute(directionsService, directionsDisplay,
            ...
            //var _origin = prompt("What City and State(e.g. Atlanta, GA) are you traveling from?");
            var _origin = $('#city').val() + ', ' + $('#state').val();
            directionsDisplay.setMap($scope.map);
